...
local function BuildSettingsPopup()
    ...
    UH.CreateTitleBar(popup, "EbonBuilds Settings")
    UH.CreateCloseButton(popup)
...
local function BuildFrame()
    ...
    frame:SetBackdrop(UH.Backdrop("dialog"))
    UH.CreateTitleBar(frame, "EbonBuilds")
    local closeBtn = UH.CreateCloseButton(frame)
